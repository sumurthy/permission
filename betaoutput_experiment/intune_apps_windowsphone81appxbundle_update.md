...
Update the properties of a [windowsPhone81AppXBundle](../resources/intune_apps_windowsphone81appxbundle.md) object.
## HTTP Request
<!-- {
  "blockType": "ignored"
}
...
## Request body
In the request body, supply a JSON representation of a [windowsPhone81AppXBundle](../resources/intune_apps_windowsphone81appxbundle.md) object.
The following table shows the properties that are required when you create a [windowsPhone81AppXBundle](../resources/intune_apps_windowsphone81appxbundle.md).
