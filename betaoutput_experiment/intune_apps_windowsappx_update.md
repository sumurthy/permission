...
## Request body
In the request body, supply a JSON representation of a [windowsAppX](../resources/intune_apps_windowsappx.md) object.
The following table shows the properties that are required when you create a [windowsAppX](../resources/intune_apps_windowsappx.md).
