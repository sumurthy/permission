...
Update the properties of a [windowsUniversalAppX](../resources/intune_apps_windowsuniversalappx.md) object.
## HTTP Request
<!-- {
  "blockType": "ignored"
}
...
## Request body
In the request body, supply a JSON representation of a [windowsUniversalAppX](../resources/intune_apps_windowsuniversalappx.md) object.
The following table shows the properties that are required when you create a [windowsUniversalAppX](../resources/intune_apps_windowsuniversalappx.md).
