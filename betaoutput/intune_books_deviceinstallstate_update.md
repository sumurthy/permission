...
## Request body
In the request body, supply a JSON representation of a [deviceInstallState](../resources/intune_books_deviceinstallstate.md) object.
The following table shows the properties that are required when you create a [deviceInstallState](../resources/intune_books_deviceinstallstate.md).
