...
-->
```http
PATCH /importedAppleDeviceIdentityResults/{importedAppleDeviceIdentityResultsId}
```
...
```http
PATCH https://graph.microsoft.com/beta/importedAppleDeviceIdentityResults/{importedAppleDeviceIdentityResultsId}
