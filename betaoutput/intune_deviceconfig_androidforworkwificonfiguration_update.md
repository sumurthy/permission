...
Update the properties of a [androidForWorkWiFiConfiguration](../resources/intune_deviceconfig_androidforworkwificonfiguration.md) object.
## Permissions
...
## Request body
In the request body, supply a JSON representation of a [androidForWorkWiFiConfiguration](../resources/intune_deviceconfig_androidforworkwificonfiguration.md) object.
The following table shows the properties that are required when you create a [androidForWorkWiFiConfiguration](../resources/intune_deviceconfig_androidforworkwificonfiguration.md).
...
If successful, this method returns a `200 OK` response code and an updated [androidForWorkWiFiConfiguration](../resources/intune_deviceconfig_androidforworkwificonfiguration.md) object in the response body.
