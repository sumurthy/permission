...
Create a new [defaultManagedAppProtection](../resources/intune_mam_defaultmanagedappprotection.md) by posting to the defaultManagedAppProtections collection.
## Permissions
