...
Update the properties of a [windowsPhoneEASEmailProfileConfiguration](../resources/intune_deviceconfig_windowsphoneeasemailprofileconfiguration.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [windowsPhoneEASEmailProfileConfiguration](../resources/intune_deviceconfig_windowsphoneeasemailprofileconfiguration.md) object.
The following table shows the properties that are required when you create a [windowsPhoneEASEmailProfileConfiguration](../resources/intune_deviceconfig_windowsphoneeasemailprofileconfiguration.md).
...
If successful, this method returns a `200 OK` response code and an updated [windowsPhoneEASEmailProfileConfiguration](../resources/intune_deviceconfig_windowsphoneeasemailprofileconfiguration.md) object in the response body.
