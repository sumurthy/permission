...
## Request body
In the request body, supply a JSON representation of a androidTrustedRootCertificate object.
The following table shows the properties that are required when you create a androidTrustedRootCertificate.
