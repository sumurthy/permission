...
Create a new [mdmWindowsInformationProtectionPolicy](../resources/intune_mam_mdmwindowsinformationprotectionpolicy.md) by posting to the mdmWindowsInformationProtectionPolicies collection.
## Permissions
