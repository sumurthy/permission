...
```http
GET https://graph.microsoft.com/beta/reports/SfbDeviceUsage(view='Detail',period='D7')/content
```
...
Location: https://reports.office.com/data/download/odffer_eJXKS034dbc7e0t__XDezYGO-NQw
```
...
GET https://graph.microsoft.com/beta/reports/SfbDeviceUsage(view='Distribution',period='D7')/content
GET https://graph.microsoft.com/beta/reports/SfbDeviceUsage(view='Users',period='D7')/content
```
