...
Create a new [windowsPhoneXAP](../resources/intune_apps_windowsphonexap.md) object.
## Permissions
...
## Request body
In the request body, supply a JSON representation of a windowsPhoneXAP object.
The following table shows the properties that are required when you create a windowsPhoneXAP.
