...
Update the properties of a [windowsManagedDevice](../resources/intune_devicefe_windowsmanageddevice.md) object.
## Permissions
...
## Request body
In the request body, supply a JSON representation of a [windowsManagedDevice](../resources/intune_devicefe_windowsmanageddevice.md) object.
The following table shows the properties that are required when you create a [windowsManagedDevice](../resources/intune_devicefe_windowsmanageddevice.md).
...
If successful, this method returns a `200 OK` response code and an updated [windowsManagedDevice](../resources/intune_devicefe_windowsmanageddevice.md) object in the response body.
