...
Create a new [defaultDeviceCompliancePolicy](../resources/intune_deviceconfig_defaultdevicecompliancepolicy.md) object.
## Permissions
...
## Request body
In the request body, supply a JSON representation of a defaultDeviceCompliancePolicy object.
The following table shows the properties that are required when you create a defaultDeviceCompliancePolicy.
