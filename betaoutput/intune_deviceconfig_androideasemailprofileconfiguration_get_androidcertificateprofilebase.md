...
Get the [androidCertificateProfileBase](../resources/intune_deviceconfig_androidcertificateprofilebase.md) from the smimeSigningCertificate navigation property.
## Prerequisites
