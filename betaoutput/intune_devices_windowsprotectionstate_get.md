...
Read properties and relationships of the [windowsProtectionState](../resources/intune_devices_windowsprotectionstate.md) object.
## Permissions
...
If successful, this method returns a `200 OK` response code and [windowsProtectionState](../resources/intune_devices_windowsprotectionstate.md) object in the response body.
