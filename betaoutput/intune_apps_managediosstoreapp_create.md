...
Create a new [managedIOSStoreApp](../resources/intune_apps_managediosstoreapp.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a managedIOSStoreApp object.
The following table shows the properties that are required when you create a managedIOSStoreApp.
