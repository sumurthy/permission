...
## Request body
In the request body, supply a JSON representation of a [iosEduDeviceConfiguration](../resources/intune_deviceconfig_iosedudeviceconfiguration.md) object.
The following table shows the properties that are required when you create a [iosEduDeviceConfiguration](../resources/intune_deviceconfig_iosedudeviceconfiguration.md).
