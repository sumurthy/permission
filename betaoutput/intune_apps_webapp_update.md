...
Update the properties of a [webApp](../resources/intune_apps_webapp.md) object.
## Prerequisites
...
## Request body
In the request body, supply a JSON representation of a [webApp](../resources/intune_apps_webapp.md) object.
The following table shows the properties that are required when you create a [webApp](../resources/intune_apps_webapp.md).
