...
## Request body
In the request body, supply a JSON representation of a [androidForWorkApp](../resources/intune_apps_androidforworkapp.md) object.
The following table shows the properties that are required when you create a [androidForWorkApp](../resources/intune_apps_androidforworkapp.md).
