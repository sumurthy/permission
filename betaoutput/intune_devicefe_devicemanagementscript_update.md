...
Update the properties of a [deviceManagementScript](../resources/intune_devicefe_devicemanagementscript.md) object.
## Permissions
...
## Request body
In the request body, supply a JSON representation of a [deviceManagementScript](../resources/intune_devicefe_devicemanagementscript.md) object.
The following table shows the properties that are required when you create a [deviceManagementScript](../resources/intune_devicefe_devicemanagementscript.md).
...
If successful, this method returns a `200 OK` response code and an updated [deviceManagementScript](../resources/intune_devicefe_devicemanagementscript.md) object in the response body.
